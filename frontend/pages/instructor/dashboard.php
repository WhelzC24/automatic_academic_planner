...
<div class="main-content">
  <div class="topbar">
    <div class="topbar-title"><h1>Instructor Dashboard</h1><p id="curr-date"></p></div>
    ...
    <div class="instructor-content-grid">
      <div>
        <div class="stats-grid" id="stats-row">
          <div class="stat-card"><div class="stat-icon blue"><i class="fas fa-book-open"></i></div>
            <div class="stat-info"><div class="value" id="s-courses">–</div><div class="label">My Courses</div></div></div>
          <div class="stat-card"><div class="stat-icon orange"><i class="fas fa-clipboard-list"></i></div>
            <div class="stat-info"><div class="value" id="s-assignments">–</div><div class="label">Assignments</div></div></div>
          <div class="stat-card"><div class="stat-icon green"><i class="fas fa-upload"></i></div>
            <div class="stat-info"><div class="value" id="s-subs">–</div><div class="label">Recent Submissions</div></div></div>
          <div class="stat-card"><div class="stat-icon gold"><i class="fas fa-users"></i></div>
            <div class="stat-info"><div class="value" id="s-students">–</div><div class="label">Total Students</div></div></div>
        </div>
      ...
      <aside class="instructor-side">
        <div class="card">
          <div class="card-header"><div class="card-title"><i class="fas fa-chart-pie"></i> Teaching Snapshot</div></div>
          <div class="card-body">
