        ...
        <aside class="admin-users-side">
          <div class="card" style="margin-bottom:1.25rem">
            <div class="card-header">
              <div class="card-title"><i class="fas fa-chart-pie"></i> User Breakdown</div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-body">
      ...
      <div class="form-row">
        <div class="form-group"><label>First Name *</label>
          <input type="text" class="form-control" id="u-first">
        </div>
        <div class="form-group"><label>Last Name *</label>
          <input type="text" class="form-control" id="u-last">
        </div>
      </div>
      <div class="form-row">
      ...
      <div id="student-fields">
        <div class="form-row">
          <div class="form-group"><label>Student Number *</label>
            <input type="text" class="form-control" id="u-sn" placeholder="ID Number">
          </div>
      ...
      <div id="instructor-fields" style="display:none">
        ...
        <div class="form-group"><label>Office Location</label>
          <input type="text" class="form-control" id="u-office" placeholder="Room 201, Bldg A">
        </div>
      </div>
    </div>
...
<div class="modal-overlay" id="delete-user-modal">
  <div class="modal" style="max-width:460px">
    <div class="modal-header">
      <div class="modal-title"><i class="fas fa-trash"></i> Confirm User Deletion</div>
      <button class="modal-close" onclick="closeDeleteUserModal()"><i class="fas fa-times"></i></button>
    </div>
    <div class="modal-body">
      <p style="color:var(--slate);font-size:.9rem;line-height:1.5;margin:0;">
        Delete user <strong id="delete-user-name">this user</strong>?
      </p>
      <p style="color:var(--slate);font-size:.82rem;line-height:1.5;margin-top:.85rem;">
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-danger" id="confirm-delete-user-btn" onclick="confirmDeleteUser()">
