      ...
      <div class="admin-enroll-grid">
        <div class="admin-enroll-main">
          ...
          <div class="stats-grid admin-enroll-stats">
            ...
            <div class="stat-card">
              ...
              <div class="stat-info">
                <div class="value" id="stat-offerings">–</div>
                <div class="label">Active Offerings</div>
              </div>
            </div>
            <div class="stat-card">
        ...
        <aside class="admin-enroll-side">
          <div class="card" style="margin-bottom:1.25rem">
            <div class="card-header">
              <div class="card-title"><i class="fas fa-chart-pie"></i> Enrollment Overview</div>
            </div>
            <div class="card-body">
...
<div class="modal-overlay" id="enroll-modal">
  <div class="modal">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        <label>Student *</label>
        <select class="form-control" id="e-student">
...
<div class="modal-overlay" id="unenroll-modal">
  <div class="modal" style="max-width:460px">
    <div class="modal-header">
      <div class="modal-title"><i class="fas fa-user-minus"></i> Remove Enrollment</div>
      <button class="modal-close" onclick="closeUnenrollModal()"><i class="fas fa-times"></i></button>
    </div>
    <div class="modal-body">
      <p style="color:var(--text);margin:0">Remove this student enrollment?</p>
      <p style="color:var(--slate);font-size:.85rem;margin:.5rem 0 0">
        The student will lose access to this course.
      </p>
    </div>
    <div class="modal-footer">
      <button class="btn btn-outline" onclick="closeUnenrollModal()">Cancel</button>
      <button class="btn btn-danger" id="confirm-unenroll-btn" onclick="confirmUnenroll()">
        <i class="fas fa-user-minus"></i> Remove Enrollment
      </button>
    </div>
  </div>
</div>

<script src="<?= APP_URL ?>/frontend/assets/js/pages/admin/enrollments.js?v=<?= $enrollmentsJsVersion ?>"></script>
<?php layout_footer(); ?>