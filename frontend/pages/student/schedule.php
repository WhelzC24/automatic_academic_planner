...
<div class="main-content">
  <div class="topbar">
    <div class="topbar-title"><h1>My Schedule</h1><p>Weekly and monthly view of your academic schedule</p></div>
...
function changeWeek(dir) { weekStart.setDate(weekStart.getDate() + dir * 7); renderWeek(); }
...
async function renderWeek() {
  ...
  const res  = await fetch(`${API}?action=get_schedules&start=${startStr}&end=${endStr} 23:59:59`);
  const data = await res.json();
